      ...
      <section id="detailed-portfolio" className="section-padding bg-muted/30">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-4">
            <Badge className="badge-primary px-6 py-3">Autonomous Material Handling and transport</Badge>
            <Badge className="badge-secondary px-6 py-3">Collaborative Robotics (Cobots)</Badge>
            <Badge className="badge-primary px-6 py-3">AI Driven Control & Orchestration</Badge>
            <Badge className="badge-secondary px-6 py-3">Smart inspection and Quality Control</Badge>
          </div>
        </div>
      </section>
