        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in" style={{animationDelay: '0.4s', animationFillMode: 'both'}}>
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-2 border-white text-white hover:bg-white hover:text-foreground px-10 py-5 text-xl font-bold hover:scale-105 transition-all duration-300 backdrop-blur-sm"
            >
              Download Brochure
            </Button>
          </div>
