...
const AutoDockAdvantage = () => {
  const benefits = [
    ...
    },
    {
      ...
      text: 'Fixed systems buckle under pressure. AutoDock handles surges in truck volumes without disruption. With a central orchestration platform and modular AMRs, you can scale across docks while maximizing asset utilization.',
      icon: BarChart3,
      visual: 'dashboard'
    },
    {
