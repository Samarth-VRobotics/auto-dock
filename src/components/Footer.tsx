const Footer = () => {
  return (
    <footer className="bg-background border-t border-border section-padding-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@aiintime.com" className="body-sm text-primary hover:text-primary/80 transition-colors">
                  info@aiintime.com
                </a>
              </div>
