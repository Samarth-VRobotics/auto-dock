          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-primary/10">
              ...
              <div className="space-y-4 text-foreground/80 leading-relaxed">
                ...
                <p>
                  Under Dr. Ashok Shetter's leadership, KLETU built a culture of innovation. Today, the Department of Automation and Robotics, led by Mr. Vinayak, continues shaping future engineers.
                </p>
                <p>
