  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-muted/20 rounded-lg p-8 max-w-6xl mx-auto">
          <h3 className="text-xl font-bold text-foreground mb-6">KEY HIGHLIGHTS</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {highlights.map((highlight, index) => (
              <div key={index} className="flex items-start space-x-3">
                <div className="w-1.5 h-1.5 bg-foreground rounded-full flex-shrink-0 mt-2"></div>
