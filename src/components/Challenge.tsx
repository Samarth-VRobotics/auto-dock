...
import { 
  Truck, BarChart3, Package, Building, Link, 
  DollarSign, AlertTriangle, 
  TrendingDown, Clock, FileX, UserMinus 
} from "lucide-react";
...
const Challenge = () => {
  ...
  const operationalBottlenecks = [
    { icon: Truck, text: "Seasonal Surges" },
    { icon: BarChart3, text: "Throughput Uncertainty" },
    { icon: Package, text: "Unstructured Loads" },
    { icon: Building, text: "Rigid Layouts" },
    { icon: Link, text: "Integration Gaps" }
  ];
  ...
  const AnimatedNumber = ({ value, duration = 2000 }: { value: string; duration?: number }) => {
    ...
    return (
      <span className={`font-bold transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        {displayValue}
      </span>
    );
  };
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              <div className="bg-background/95 backdrop-blur-sm rounded-3xl border border-blue-200/50 p-8 h-full relative overflow-hidden group hover:shadow-xl transition-all duration-500">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-lg font-inter font-semibold text-blue-700 mb-4 leading-tight">
                    Where rigid systems meet unpredictable reality
                  </h4>
                  
                  <p className="text-muted-foreground mb-6 leading-relaxed font-inter">
                    Seasonal peaks, unstructured loads, and blind spots create dock slowdowns that structured warehouse systems can't prevent.
                  </p>
                  
                  <div className="space-y-3">
                    {operationalBottlenecks.map((item, index) => (
                      <div key={index} className="flex items-center space-x-3 group/item">
                        <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover/item:bg-blue-200 transition-colors">
                          <item.icon className="w-4 h-4 text-blue-600" strokeWidth={1.5} />
                        </div>
                        <span className="text-foreground font-medium font-inter">{item.text}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
              <div className="bg-background/95 backdrop-blur-sm rounded-3xl border border-orange-200/50 p-8 h-full relative overflow-hidden group hover:shadow-xl transition-all duration-500">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-lg font-inter font-semibold text-orange-700 mb-4 leading-tight">
                    Every wasted hour shows up on your balance sheet
                  </h4>
                  
                  <p className="text-muted-foreground mb-6 leading-relaxed font-inter">
                    Idle trucks and emergency fixes drive up operating costs faster than you realize.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="bg-orange-50/50 rounded-xl p-4 border border-orange-200/30">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <div className="font-inter font-semibold text-foreground mb-1">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
              <div className="bg-background/95 backdrop-blur-sm rounded-3xl border border-green-200/50 p-8 h-full relative overflow-hidden group hover:shadow-xl transition-all duration-500">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-lg font-inter font-semibold text-green-700 mb-4 leading-tight">
                    Dock delays don't just waste time — they cost sales
                  </h4>
                  
                  <p className="text-muted-foreground mb-6 leading-relaxed font-inter">
                    When bottlenecks spill over, you lose more than hours — you lose customers and long-term growth.
                  </p>
