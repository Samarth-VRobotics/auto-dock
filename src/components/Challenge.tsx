...
const Challenge = () => {
  ...
  const operationalBottlenecks = [
    { icon: Truck, text: "Seasonal Surges", description: "overloaded docks, missed turnarounds" },
    { icon: BarChart3, text: "Throughput Uncertainty", description: "fluctuating flow rates" },
    { icon: Package, text: "Unstructured Loads", description: "manual floor-loaded cartons" },
    { icon: Building, text: "Rigid Layouts", description: "fixed infrastructure limits" },
    { icon: Link, text: "Integration Gaps", description: "ERP/WMS blind spots" }
  ];
